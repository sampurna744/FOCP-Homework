...
#17
address = ("1234", "Jorpati,Kathmandu", "H098")
print(address)
# ('1234', 'Jorpati,Kathmandu', 'H098')
...
# Tuple:Immutable, ordered collection in parentheses.
